  ...
  return {
    ...
    exclusionCriteria:
      study.protocolSection.eligibilityModule.eligibilityCriteria
        ...
        .filter((c: string) => c.startsWith("*"))
        .map((c: string) => c.substring(1).trim()),
    locationsDescription: `The study is conducted at ${study.protocolSection.contactsLocationsModule.locations[0].facility.city}, ${study.protocolSection.contactsLocationsModule.locations[0].facility.state}, ${study.protocolSection.contactsLocationsModule.locations[0].facility.country}.`,
    principalInvestigator: {
    ...
    studyCoordinator: {
      name: study.protocolSection.contactsLocationsModule.overallOfficials[0]
        .name,
      institution:
        study.protocolSection.contactsLocationsModule.overallOfficials[0]
          .affiliation,
      address: "Address not available", // Address is not provided in the data
